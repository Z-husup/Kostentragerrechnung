 ...
 * <ul>
 *   <li>Method signature changed from <code>void</code> to<br>
 *       <code>CalculationResult calculateCosts(...)</code>.</li>
 *   <li>All cost columns are written back into the domain objects <em>and</em>
 *       included in the returned record.</li>
 *   <li>Console output kept for transparency but can be toggled via flag.</li>
 * </ul>
 */
public class CalculationService {
     ...
     */
    public CalculationResult calculateCosts(
